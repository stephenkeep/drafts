  ...
  module.exports = function (scribe) {
    ...
    Selection.prototype.placeMarkers = function () {
      ...
      if (endMarker.nextSibling &&
          endMarker.nextSibling.nodeType === window.Node.TEXT_NODE
      ...
      if (endMarker.previousSibling &&
          endMarker.previousSibling.nodeType === window.Node.TEXT_NODE
      ...
      if (! this.selection.isCollapsed) {
        ...
        if (startMarker.nextSibling &&
            startMarker.nextSibling.nodeType === window.Node.TEXT_NODE
        ...
        if (startMarker.previousSibling &&
            startMarker.previousSibling.nodeType === window.Node.TEXT_NODE
